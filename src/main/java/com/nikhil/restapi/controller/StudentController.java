...
import com.nikhil.restapi.response.StudentResponse;
import com.nikhil.restapi.service.StudentService;
...
//		logger.info("inQueryRequest = " + inQueryRequest);
	...
	public List<StudentResponse> getAllStudentWithsPagination(@RequestParam int pageNo, @RequestParam int pageSize) {
	...
	public String deleteStudent(@PathVariable String firstName) {
		return studentService.deleteStudentByFirstName(firstName) + " Student(s) deleted";
	}
